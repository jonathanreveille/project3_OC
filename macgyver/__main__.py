...
import pygame as pg
from config.settings import HERO, WIDTH, HEIGHT, BACKGROUND, VELOCITY, GUARD, WALL, SPRITE_HEIGHT, SPRITE_WIDTH, TUBE_PATH, ETHER_PATH, NEEDLE_PATH
from .views.needle import Needle
...
class Game:
    ...
    def __init__(self): 
        ...
        self.guard = pg.image.load(GUARD).convert()
        ...
        # on peut faire pareil avec le garde (fin du jeu)
        # ne pas mettre wall et sprite = element statique
    ...
    def start(self): # method to launch the game
        ...
        while self.running:
            ...
            clock.tick(30) #Frame per seconds, in order words : the speed of the loop
