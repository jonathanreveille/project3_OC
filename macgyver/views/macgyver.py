...
import pygame as pg
from config.settings import HERO, SPRITE_WIDTH, SPRITE_HEIGHT
...
class MacGyver(pg.sprite.Sprite):
    ...
    def __init__(self, hero):
        ...
        # calling sprites class to initialize object,
        # use of super().__init__()
        super().__init__()
        self.image = pg.image.load(HERO).convert_alpha()
    ...
    def _process_keyboard_events(self):
        """ Method that captures events keys from gamer and it
        does action in the game"""
